...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_set_error_action(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  arg1 = static_cast< mfem::ErrorAction >(val1);
  {
    try {
      mfem::set_error_action(arg1);
    }
...
SWIGINTERN PyObject *_wrap_get_error_action(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  mfem::ErrorAction result;
  
  if (!SWIG_Python_UnpackTuple(args, "get_error_action", 0, 0, 0)) SWIG_fail;
  {
    try {
      result = (mfem::ErrorAction)mfem::get_error_action();
    }
#ifdef  MFEM_USE_EXCEPTIONS
    catch (mfem::ErrorException &_e) {
      std::string s("PyMFEM error (mfem::ErrorException): "), s2(_e.what());
...
SWIGINTERN PyObject *_wrap_mfem_backtrace(PyObject *self, PyObject *args, PyObject *kwargs) {
  PyObject *resultobj = 0;
  int arg1 = (int) 0 ;
  int arg2 = (int) -1 ;
  int val1 ;
...
SWIGINTERN PyObject *_wrap_mfem_error(PyObject *self, PyObject *args, PyObject *kwargs) {
  PyObject *resultobj = 0;
  char *arg1 = (char *) NULL ;
  int res1 ;
  char *buf1 = 0 ;
...
SWIGINTERN PyObject *_wrap_mfem_warning(PyObject *self, PyObject *args, PyObject *kwargs) {
  PyObject *resultobj = 0;
  char *arg1 = (char *) NULL ;
  int res1 ;
  char *buf1 = 0 ;
...
# endif
  ...
  SWIG_Python_SetConstant(d, "MFEM_ERROR_ABORT",SWIG_From_int(static_cast< int >(mfem::MFEM_ERROR_ABORT)));
  SWIG_Python_SetConstant(d, "MFEM_ERROR_THROW",SWIG_From_int(static_cast< int >(mfem::MFEM_ERROR_THROW)));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
