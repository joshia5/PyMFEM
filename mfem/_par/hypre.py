...
class HypreParMatrix(mfem._par.operators.Operator):
    ...
    def EnsureMultTranspose(self):
        r"""EnsureMultTranspose(HypreParMatrix self)"""
        return _hypre.HypreParMatrix_EnsureMultTranspose(self)
    EnsureMultTranspose = _swig_new_instance_method(_hypre.HypreParMatrix_EnsureMultTranspose)

    def ResetTranspose(self):
        r"""ResetTranspose(HypreParMatrix self)"""
        return _hypre.HypreParMatrix_ResetTranspose(self)
    ResetTranspose = _swig_new_instance_method(_hypre.HypreParMatrix_ResetTranspose)
    ...
    def AddMult(self, x, y, a=1.0):
        r"""AddMult(HypreParMatrix self, Vector x, Vector y, double const a=1.0)"""
        return _hypre.HypreParMatrix_AddMult(self, x, y, a)
    AddMult = _swig_new_instance_method(_hypre.HypreParMatrix_AddMult)

    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(HypreParMatrix self, Vector x, Vector y, double const a=1.0)"""
        return _hypre.HypreParMatrix_AddMultTranspose(self, x, y, a)
    AddMultTranspose = _swig_new_instance_method(_hypre.HypreParMatrix_AddMultTranspose)
    ...
    def EliminateBC(self, *args):
        ...
        """
        return _hypre.HypreParMatrix_EliminateBC(self, *args)
    ...
    def GetDiagMemoryI(self, *args):
        r"""
        GetDiagMemoryI(HypreParMatrix self) -> mfem::Memory< HYPRE_Int >
        GetDiagMemoryI(HypreParMatrix self) -> mfem::Memory< HYPRE_Int > const &
        """
        return _hypre.HypreParMatrix_GetDiagMemoryI(self, *args)
    GetDiagMemoryI = _swig_new_instance_method(_hypre.HypreParMatrix_GetDiagMemoryI)

    def GetDiagMemoryJ(self, *args):
        r"""
        GetDiagMemoryJ(HypreParMatrix self) -> mfem::Memory< HYPRE_Int >
        GetDiagMemoryJ(HypreParMatrix self) -> mfem::Memory< HYPRE_Int > const &
        """
        return _hypre.HypreParMatrix_GetDiagMemoryJ(self, *args)
    GetDiagMemoryJ = _swig_new_instance_method(_hypre.HypreParMatrix_GetDiagMemoryJ)

    def GetDiagMemoryData(self, *args):
        r"""
        GetDiagMemoryData(HypreParMatrix self) -> mfem::Memory< double >
        GetDiagMemoryData(HypreParMatrix self) -> mfem::Memory< double > const &
        """
        return _hypre.HypreParMatrix_GetDiagMemoryData(self, *args)
    GetDiagMemoryData = _swig_new_instance_method(_hypre.HypreParMatrix_GetDiagMemoryData)
...
def HypreStealOwnership(A_hyp, A_diag):
    r"""HypreStealOwnership(HypreParMatrix A_hyp, SparseMatrix A_diag)"""
    return _hypre.HypreStealOwnership(A_hyp, A_diag)
HypreStealOwnership = _hypre.HypreStealOwnership
...
class HypreSolver(mfem._par.operators.Solver):
    ...
    def Setup(self, *args):
        ...
        """
        return _hypre.HypreSolver_Setup(self, *args)
    Setup = _swig_new_instance_method(_hypre.HypreSolver_Setup)
...
class HyprePCG(HypreSolver):
    ...
    def GetFinalResidualNorm(self, final_res_norm):
        r"""GetFinalResidualNorm(HyprePCG self, double & final_res_norm)"""
        return _hypre.HyprePCG_GetFinalResidualNorm(self, final_res_norm)
    GetFinalResidualNorm = _swig_new_instance_method(_hypre.HyprePCG_GetFinalResidualNorm)
...
class HypreGMRES(HypreSolver):
    ...
    def GetNumIterations(self, num_iterations):
        r"""GetNumIterations(HypreGMRES self, int & num_iterations)"""
        return _hypre.HypreGMRES_GetNumIterations(self, num_iterations)
    GetNumIterations = _swig_new_instance_method(_hypre.HypreGMRES_GetNumIterations)

    def GetFinalResidualNorm(self, final_res_norm):
        r"""GetFinalResidualNorm(HypreGMRES self, double & final_res_norm)"""
        return _hypre.HypreGMRES_GetFinalResidualNorm(self, final_res_norm)
    GetFinalResidualNorm = _swig_new_instance_method(_hypre.HypreGMRES_GetFinalResidualNorm)
...
class HypreFGMRES(HypreSolver):
    ...
    def GetNumIterations(self, num_iterations):
        r"""GetNumIterations(HypreFGMRES self, int & num_iterations)"""
        return _hypre.HypreFGMRES_GetNumIterations(self, num_iterations)
    GetNumIterations = _swig_new_instance_method(_hypre.HypreFGMRES_GetNumIterations)

    def GetFinalResidualNorm(self, final_res_norm):
        r"""GetFinalResidualNorm(HypreFGMRES self, double & final_res_norm)"""
        return _hypre.HypreFGMRES_GetFinalResidualNorm(self, final_res_norm)
    GetFinalResidualNorm = _swig_new_instance_method(_hypre.HypreFGMRES_GetFinalResidualNorm)
...
class HypreParaSails(HypreSolver):
    ...
    def SetParams(self, threshold, max_levels):
        r"""SetParams(HypreParaSails self, double threshold, int max_levels)"""
        return _hypre.HypreParaSails_SetParams(self, threshold, max_levels)
    SetParams = _swig_new_instance_method(_hypre.HypreParaSails_SetParams)

    def SetFilter(self, filter):
        r"""SetFilter(HypreParaSails self, double filter)"""
        return _hypre.HypreParaSails_SetFilter(self, filter)
    SetFilter = _swig_new_instance_method(_hypre.HypreParaSails_SetFilter)

    def SetLoadBal(self, loadbal):
        r"""SetLoadBal(HypreParaSails self, double loadbal)"""
        return _hypre.HypreParaSails_SetLoadBal(self, loadbal)
    SetLoadBal = _swig_new_instance_method(_hypre.HypreParaSails_SetLoadBal)

    def SetReuse(self, reuse):
        r"""SetReuse(HypreParaSails self, int reuse)"""
        return _hypre.HypreParaSails_SetReuse(self, reuse)
    SetReuse = _swig_new_instance_method(_hypre.HypreParaSails_SetReuse)

    def SetLogging(self, logging):
        r"""SetLogging(HypreParaSails self, int logging)"""
        return _hypre.HypreParaSails_SetLogging(self, logging)
    SetLogging = _swig_new_instance_method(_hypre.HypreParaSails_SetLogging)
...
class HypreEuclid(HypreSolver):
    ...
    def SetLevel(self, level):
        r"""SetLevel(HypreEuclid self, int level)"""
        return _hypre.HypreEuclid_SetLevel(self, level)
    SetLevel = _swig_new_instance_method(_hypre.HypreEuclid_SetLevel)

    def SetStats(self, stats):
        r"""SetStats(HypreEuclid self, int stats)"""
        return _hypre.HypreEuclid_SetStats(self, stats)
    SetStats = _swig_new_instance_method(_hypre.HypreEuclid_SetStats)

    def SetMemory(self, mem):
        r"""SetMemory(HypreEuclid self, int mem)"""
        return _hypre.HypreEuclid_SetMemory(self, mem)
    SetMemory = _swig_new_instance_method(_hypre.HypreEuclid_SetMemory)

    def SetBJ(self, bj):
        r"""SetBJ(HypreEuclid self, int bj)"""
        return _hypre.HypreEuclid_SetBJ(self, bj)
    SetBJ = _swig_new_instance_method(_hypre.HypreEuclid_SetBJ)

    def SetRowScale(self, row_scale):
        r"""SetRowScale(HypreEuclid self, int row_scale)"""
        return _hypre.HypreEuclid_SetRowScale(self, row_scale)
    SetRowScale = _swig_new_instance_method(_hypre.HypreEuclid_SetRowScale)
...
class HypreILU(HypreSolver):
    ...
    def SetType(self, ilu_type):
        r"""SetType(HypreILU self, HYPRE_Int ilu_type)"""
        return _hypre.HypreILU_SetType(self, ilu_type)
    SetType = _swig_new_instance_method(_hypre.HypreILU_SetType)

    def SetMaxIter(self, max_iter):
        r"""SetMaxIter(HypreILU self, HYPRE_Int max_iter)"""
        return _hypre.HypreILU_SetMaxIter(self, max_iter)
    SetMaxIter = _swig_new_instance_method(_hypre.HypreILU_SetMaxIter)

    def SetTol(self, tol):
        r"""SetTol(HypreILU self, HYPRE_Real tol)"""
        return _hypre.HypreILU_SetTol(self, tol)
    SetTol = _swig_new_instance_method(_hypre.HypreILU_SetTol)

    def SetLocalReordering(self, reorder_type):
        r"""SetLocalReordering(HypreILU self, HYPRE_Int reorder_type)"""
        return _hypre.HypreILU_SetLocalReordering(self, reorder_type)
    SetLocalReordering = _swig_new_instance_method(_hypre.HypreILU_SetLocalReordering)
...
class HypreAMS(HypreSolver):
    ...
    def __init__(self, *args):
        ...
        __init__(HypreAMS self, HypreParMatrix A, HypreParMatrix G_, HypreParVector x_, HypreParVector y_, HypreParVector z_=None) -> HypreAMS
        """
...
class HypreADS(HypreSolver):
    ...
    def __init__(self, *args):
        ...
        __init__(HypreADS self, HypreParMatrix A, HypreParMatrix C_, HypreParMatrix G_, HypreParVector x_, HypreParVector y_, HypreParVector z_) -> HypreADS
        """
