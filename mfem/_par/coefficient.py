...
class PWCoefficient(Coefficient):
    ...
    def __init__(self, *args):
        ...
        __init__(PWCoefficient self, intArray attr, mfem::Array< mfem::Coefficient * > const & coefs) -> PWCoefficient
        """
    ...
    def SetTime(self, t):
        r"""SetTime(PWCoefficient self, double t)"""
    ...
    def UpdateCoefficients(self, attr, coefs):
        r"""UpdateCoefficients(PWCoefficient self, intArray attr, mfem::Array< mfem::Coefficient * > const & coefs)"""
    ...
    def Eval(self, T, ip):
        r"""Eval(PWCoefficient self, ElementTransformation T, IntegrationPoint ip) -> double"""
...
class PWVectorCoefficient(VectorCoefficient):
    ...
    def __init__(self, *args):
        ...
        __init__(PWVectorCoefficient self, int vd, intArray attr, mfem::Array< mfem::VectorCoefficient * > const & coefs) -> PWVectorCoefficient
        """
    ...
    def SetTime(self, t):
        r"""SetTime(PWVectorCoefficient self, double t)"""
    ...
    def UpdateCoefficients(self, attr, coefs):
        r"""UpdateCoefficients(PWVectorCoefficient self, intArray attr, mfem::Array< mfem::VectorCoefficient * > const & coefs)"""
...
class PWMatrixCoefficient(MatrixCoefficient):
    ...
    def __init__(self, *args):
        ...
        __init__(PWMatrixCoefficient self, int dim, intArray attr, mfem::Array< mfem::MatrixCoefficient * > const & coefs, bool symm=False) -> PWMatrixCoefficient
        __init__(PWMatrixCoefficient self, int h, int w, intArray attr, mfem::Array< mfem::MatrixCoefficient * > const & coefs, bool symm=False) -> PWMatrixCoefficient
        """
        _coefficient.PWMatrixCoefficient_swiginit(self, _coefficient.new_PWMatrixCoefficient(*args))

    def SetTime(self, t):
        r"""SetTime(PWMatrixCoefficient self, double t)"""
    ...
    def UpdateCoefficients(self, attr, coefs):
        r"""UpdateCoefficients(PWMatrixCoefficient self, intArray attr, mfem::Array< mfem::MatrixCoefficient * > const & coefs)"""
...
class CoefficientVector(mfem._par.vector.Vector):
...
def SetNumbaCoefficientDependency(obj, a1, a2, a3, a4, a5, a6):
    r"""SetNumbaCoefficientDependency(NumbaCoefficientBase obj, mfem::Array< mfem::Coefficient * > const & a1, mfem::Array< mfem::VectorCoefficient * > const & a2, mfem::Array< mfem::MatrixCoefficient * > const & a3, mfem::Array< ScalarNumbaCoefficient * > const & a4, mfem::Array< VectorNumbaCoefficient * > const & a5, mfem::Array< MatrixNumbaCoefficient * > const & a6)"""
