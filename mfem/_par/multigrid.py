...
class MultigridBase(mfem._par.operators.Solver):
    ...
    def ArrayMult(self, X_, Y_):
        r"""ArrayMult(MultigridBase self, mfem::Array< mfem::Vector const * > const & X_, VectorPtrArray Y_)"""
...
class GeometricMultigrid(MultigridBase):
