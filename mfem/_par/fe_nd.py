...
class ND_WedgeElement(mfem._par.fe_base.VectorFiniteElement):
...
class ND_R1D_PointElement(mfem._par.fe_base.VectorFiniteElement):
...
class ND_R1D_SegmentElement(mfem._par.fe_base.VectorFiniteElement):
    ...
    def CalcPhysCurlShape(self, Trans, curl_shape):
        r"""CalcPhysCurlShape(ND_R1D_SegmentElement self, mfem::ElementTransformation & Trans, DenseMatrix curl_shape)"""
        return _fe_nd.ND_R1D_SegmentElement_CalcPhysCurlShape(self, Trans, curl_shape)
...
class ND_R2D_SegmentElement(mfem._par.fe_base.VectorFiniteElement):
...
class ND_R2D_FiniteElement(mfem._par.fe_base.VectorFiniteElement):
    ...
    def CalcPhysCurlShape(self, Trans, curl_shape):
        r"""CalcPhysCurlShape(ND_R2D_FiniteElement self, mfem::ElementTransformation & Trans, DenseMatrix curl_shape)"""
        return _fe_nd.ND_R2D_FiniteElement_CalcPhysCurlShape(self, Trans, curl_shape)
