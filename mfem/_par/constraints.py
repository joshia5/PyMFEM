...
class EliminationSolver(ConstrainedSolver):
    ...
    def SetPreconditioner(self, precond):
        r"""SetPreconditioner(EliminationSolver self, Solver precond)"""
        return _constraints.EliminationSolver_SetPreconditioner(self, precond)
    SetPreconditioner = _swig_new_instance_method(_constraints.EliminationSolver_SetPreconditioner)
...
class EliminationGMRESSolver(EliminationSolver):
    r"""Proxy of C++ mfem::EliminationGMRESSolver class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, A, B, constraint_rowstarts, dimension_=0, reorder_=False):
        r"""__init__(EliminationGMRESSolver self, HypreParMatrix A, SparseMatrix B, intArray constraint_rowstarts, int dimension_=0, bool reorder_=False) -> EliminationGMRESSolver"""
        _constraints.EliminationGMRESSolver_swiginit(self, _constraints.new_EliminationGMRESSolver(A, B, constraint_rowstarts, dimension_, reorder_))
    __swig_destroy__ = _constraints.delete_EliminationGMRESSolver

# Register EliminationGMRESSolver in _constraints:
_constraints.EliminationGMRESSolver_swigregister(EliminationGMRESSolver)
class PenaltyConstrainedSolver(ConstrainedSolver):
    ...
    def SetPreconditioner(self, precond):
        r"""SetPreconditioner(PenaltyConstrainedSolver self, Solver precond)"""
        return _constraints.PenaltyConstrainedSolver_SetPreconditioner(self, precond)
    SetPreconditioner = _swig_new_instance_method(_constraints.PenaltyConstrainedSolver_SetPreconditioner)
...
class PenaltyPCGSolver(PenaltyConstrainedSolver):
    ...
    def __init__(self, *args):
        ...
        __init__(PenaltyPCGSolver self, HypreParMatrix A, HypreParMatrix B, Vector penalty_, int dimension=0, bool reorder=False) -> PenaltyPCGSolver
        """
...
class PenaltyGMRESSolver(PenaltyConstrainedSolver):
    r"""Proxy of C++ mfem::PenaltyGMRESSolver class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(PenaltyGMRESSolver self, HypreParMatrix A, SparseMatrix B, double penalty_, int dimension=0, bool reorder=False) -> PenaltyGMRESSolver
        __init__(PenaltyGMRESSolver self, HypreParMatrix A, HypreParMatrix B, double penalty_, int dimension=0, bool reorder=False) -> PenaltyGMRESSolver
        __init__(PenaltyGMRESSolver self, HypreParMatrix A, HypreParMatrix B, Vector penalty_, int dimension=0, bool reorder=False) -> PenaltyGMRESSolver
        """
        _constraints.PenaltyGMRESSolver_swiginit(self, _constraints.new_PenaltyGMRESSolver(*args))
    __swig_destroy__ = _constraints.delete_PenaltyGMRESSolver

# Register PenaltyGMRESSolver in _constraints:
_constraints.PenaltyGMRESSolver_swigregister(PenaltyGMRESSolver)
...
class SchurConstrainedHypreSolver(SchurConstrainedSolver):
    ...
    def __init__(self, comm, hA_, hB_, prec=None, dimension=0, reorder=False):
        r"""__init__(SchurConstrainedHypreSolver self, MPI_Comm comm, HypreParMatrix hA_, HypreParMatrix hB_, Solver prec=None, int dimension=0, bool reorder=False) -> SchurConstrainedHypreSolver"""
        _constraints.SchurConstrainedHypreSolver_swiginit(self, _constraints.new_SchurConstrainedHypreSolver(comm, hA_, hB_, prec, dimension, reorder))
