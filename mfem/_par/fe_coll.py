...
class FiniteElementCollection(object):
    ...
    def FiniteElementForDim(self, dim):
        r"""FiniteElementForDim(FiniteElementCollection self, int dim) -> FiniteElement"""
        return _fe_coll.FiniteElementCollection_FiniteElementForDim(self, dim)
    FiniteElementForDim = _swig_new_instance_method(_fe_coll.FiniteElementCollection_FiniteElementForDim)
    ...
    def GetRangeType(self, dim):
        r"""GetRangeType(FiniteElementCollection self, int dim) -> int"""
        return _fe_coll.FiniteElementCollection_GetRangeType(self, dim)
    GetRangeType = _swig_new_instance_method(_fe_coll.FiniteElementCollection_GetRangeType)

    def GetDerivRangeType(self, dim):
        r"""GetDerivRangeType(FiniteElementCollection self, int dim) -> int"""
        return _fe_coll.FiniteElementCollection_GetDerivRangeType(self, dim)
    GetDerivRangeType = _swig_new_instance_method(_fe_coll.FiniteElementCollection_GetDerivRangeType)

    def GetMapType(self, dim):
        r"""GetMapType(FiniteElementCollection self, int dim) -> int"""
        return _fe_coll.FiniteElementCollection_GetMapType(self, dim)
    GetMapType = _swig_new_instance_method(_fe_coll.FiniteElementCollection_GetMapType)

    def GetDerivType(self, dim):
        r"""GetDerivType(FiniteElementCollection self, int dim) -> int"""
        return _fe_coll.FiniteElementCollection_GetDerivType(self, dim)
    GetDerivType = _swig_new_instance_method(_fe_coll.FiniteElementCollection_GetDerivType)

    def GetDerivMapType(self, dim):
        r"""GetDerivMapType(FiniteElementCollection self, int dim) -> int"""
        return _fe_coll.FiniteElementCollection_GetDerivMapType(self, dim)
    GetDerivMapType = _swig_new_instance_method(_fe_coll.FiniteElementCollection_GetDerivMapType)
