...
class ParMesh(mfem._par.mesh.Mesh):
    ...
    partitioning_cache = property(_pmesh.ParMesh_partitioning_cache_get, _pmesh.ParMesh_partitioning_cache_set, doc=r"""partitioning_cache : p.int""")
    ...
    def GetSharedEdgeCommunicator(self, sedge_comm):
        r"""GetSharedEdgeCommunicator(ParMesh self, GroupCommunicator sedge_comm)"""
        return _pmesh.ParMesh_GetSharedEdgeCommunicator(self, sedge_comm)
    GetSharedEdgeCommunicator = _swig_new_instance_method(_pmesh.ParMesh_GetSharedEdgeCommunicator)

    def GetSharedVertexCommunicator(self, svert_comm):
        r"""GetSharedVertexCommunicator(ParMesh self, GroupCommunicator svert_comm)"""
        return _pmesh.ParMesh_GetSharedVertexCommunicator(self, svert_comm)
    GetSharedVertexCommunicator = _swig_new_instance_method(_pmesh.ParMesh_GetSharedVertexCommunicator)

    def GetSharedQuadCommunicator(self, squad_comm):
        r"""GetSharedQuadCommunicator(ParMesh self, GroupCommunicator squad_comm)"""
        return _pmesh.ParMesh_GetSharedQuadCommunicator(self, squad_comm)
    GetSharedQuadCommunicator = _swig_new_instance_method(_pmesh.ParMesh_GetSharedQuadCommunicator)

    def GetSharedTriCommunicator(self, stria_comm):
        r"""GetSharedTriCommunicator(ParMesh self, GroupCommunicator stria_comm)"""
        return _pmesh.ParMesh_GetSharedTriCommunicator(self, stria_comm)
    GetSharedTriCommunicator = _swig_new_instance_method(_pmesh.ParMesh_GetSharedTriCommunicator)
    ...
    def __init__(self, *args):
        ...
        __init__(ParMesh self, MPI_Comm comm, apf::Mesh2 * pumi_mesh) -> ParMesh
        """
