...
def GetGlobalMPI_Comm():
    return _globals.GetGlobalMPI_Comm()
GetGlobalMPI_Comm = _globals.GetGlobalMPI_Comm

def SetGlobalMPI_Comm(comm):
    return _globals.SetGlobalMPI_Comm(comm)
SetGlobalMPI_Comm = _globals.SetGlobalMPI_Comm
