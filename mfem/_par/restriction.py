...
class ElementRestrictionOperator(mfem._par.operators.Operator):
    ...
    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(ElementRestrictionOperator self, Vector x, Vector y, double const a=1.0)"""
...
class ElementRestriction(ElementRestrictionOperator):
    ...
    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(ElementRestriction self, Vector x, Vector y, double const a=1.0)"""
...
class L2ElementRestriction(ElementRestrictionOperator):
    ...
    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(L2ElementRestriction self, Vector x, Vector y, double const a=1.0)"""
...
class FaceRestriction(mfem._par.operators.Operator):
    ...
    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(FaceRestriction self, Vector x, Vector y, double const a=1.0)"""
...
class L2FaceRestriction(FaceRestriction):
    ...
    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(L2FaceRestriction self, Vector x, Vector y, double const a=1.0)"""
...
class NCL2FaceRestriction(L2FaceRestriction):
    ...
    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(NCL2FaceRestriction self, Vector x, Vector y, double const a=1.0)"""
