...
class H1_SegmentElement(mfem._par.fe_base.NodalTensorFiniteElement):
...
class H1_QuadrilateralElement(mfem._par.fe_base.NodalTensorFiniteElement):
...
class H1_HexahedronElement(mfem._par.fe_base.NodalTensorFiniteElement):
...
class H1_TriangleElement(mfem._par.fe_base.NodalFiniteElement):
...
class H1_TetrahedronElement(mfem._par.fe_base.NodalFiniteElement):
...
class H1_WedgeElement(mfem._par.fe_base.NodalFiniteElement):
