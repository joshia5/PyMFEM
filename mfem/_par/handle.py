...
class OperatorHandle(object):
    ...
    def AddMult(self, x, y, a=1.0):
        r"""AddMult(OperatorHandle self, Vector x, Vector y, double const a=1.0)"""
        return _handle.OperatorHandle_AddMult(self, x, y, a)
    AddMult = _swig_new_instance_method(_handle.OperatorHandle_AddMult)

    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(OperatorHandle self, Vector x, Vector y, double const a=1.0)"""
        return _handle.OperatorHandle_AddMultTranspose(self, x, y, a)
    AddMultTranspose = _swig_new_instance_method(_handle.OperatorHandle_AddMultTranspose)

    def ArrayMult(self, X, Y):
        r"""ArrayMult(OperatorHandle self, mfem::Array< mfem::Vector const * > const & X, VectorPtrArray Y)"""
        return _handle.OperatorHandle_ArrayMult(self, X, Y)
    ArrayMult = _swig_new_instance_method(_handle.OperatorHandle_ArrayMult)

    def ArrayMultTranspose(self, X, Y):
        r"""ArrayMultTranspose(OperatorHandle self, mfem::Array< mfem::Vector const * > const & X, VectorPtrArray Y)"""
        return _handle.OperatorHandle_ArrayMultTranspose(self, X, Y)
    ArrayMultTranspose = _swig_new_instance_method(_handle.OperatorHandle_ArrayMultTranspose)

    def ArrayAddMult(self, X, Y, a=1.0):
        r"""ArrayAddMult(OperatorHandle self, mfem::Array< mfem::Vector const * > const & X, VectorPtrArray Y, double const a=1.0)"""
        return _handle.OperatorHandle_ArrayAddMult(self, X, Y, a)
    ArrayAddMult = _swig_new_instance_method(_handle.OperatorHandle_ArrayAddMult)

    def ArrayAddMultTranspose(self, X, Y, a=1.0):
        r"""ArrayAddMultTranspose(OperatorHandle self, mfem::Array< mfem::Vector const * > const & X, VectorPtrArray Y, double const a=1.0)"""
        return _handle.OperatorHandle_ArrayAddMultTranspose(self, X, Y, a)
    ArrayAddMultTranspose = _swig_new_instance_method(_handle.OperatorHandle_ArrayAddMultTranspose)
