...
class PositiveFiniteElement(mfem._par.fe_base.ScalarFiniteElement):
...
class PositiveTensorFiniteElement(PositiveFiniteElement, mfem._par.fe_base.TensorBasisElement):
