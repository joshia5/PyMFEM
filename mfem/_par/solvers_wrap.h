...
public:
    ...
    SwigDirector_PyIterativeSolver(PyObject *self,MPI_Comm comm_);
    ...
    virtual void ArrayAddMult(mfem::Array< mfem::Vector const * > const &X,mfem::Array< mfem::Vector * > &Y,double const a=1.0) const;
    virtual void ArrayAddMultTranspose(mfem::Array< mfem::Vector const * > const &X,mfem::Array< mfem::Vector * > &Y,double const a=1.0) const;
