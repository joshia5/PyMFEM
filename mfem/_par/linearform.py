...
class LinearForm(mfem._par.vector.Vector):
    ...
    def UseFastAssembly(self, use_fa):
        r"""UseFastAssembly(LinearForm self, bool use_fa)"""
        return _linearform.LinearForm_UseFastAssembly(self, use_fa)
    UseFastAssembly = _swig_new_instance_method(_linearform.LinearForm_UseFastAssembly)
