...
class OrthoSolver(mfem._par.operators.Solver):
    ...
    def __init__(self, *args):
        r"""
        __init__(OrthoSolver self) -> OrthoSolver
        __init__(OrthoSolver self, MPI_Comm mycomm_) -> OrthoSolver
        """
        _solvers.OrthoSolver_swiginit(self, _solvers.new_OrthoSolver(*args))
