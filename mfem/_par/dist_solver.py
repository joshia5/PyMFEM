...
class DistanceSolver(object):
    ...
    __repr__ = _swig_repr
    print_level = property(_dist_solver.DistanceSolver_print_level_get, _dist_solver.DistanceSolver_print_level_set, doc=r"""print_level : mfem::IterativeSolver::PrintLevel""")
...
class NormalizationDistanceSolver(DistanceSolver):
    ...
    def __init__(self):
        r"""__init__(NormalizationDistanceSolver self) -> NormalizationDistanceSolver"""
        _dist_solver.NormalizationDistanceSolver_swiginit(self, _dist_solver.new_NormalizationDistanceSolver())

    def ComputeScalarDistance(self, u_coeff, dist):
        r"""ComputeScalarDistance(NormalizationDistanceSolver self, Coefficient u_coeff, ParGridFunction dist)"""
        return _dist_solver.NormalizationDistanceSolver_ComputeScalarDistance(self, u_coeff, dist)
    ComputeScalarDistance = _swig_new_instance_method(_dist_solver.NormalizationDistanceSolver_ComputeScalarDistance)
    __swig_destroy__ = _dist_solver.delete_NormalizationDistanceSolver
...
class PLapDistanceSolver(DistanceSolver):
    ...
    def __init__(self, maxp_=30, newton_iter_=10, rtol=1e-7, atol=1e-12):
        r"""__init__(PLapDistanceSolver self, int maxp_=30, int newton_iter_=10, double rtol=1e-7, double atol=1e-12) -> PLapDistanceSolver"""
        _dist_solver.PLapDistanceSolver_swiginit(self, _dist_solver.new_PLapDistanceSolver(maxp_, newton_iter_, rtol, atol))
