...
class ParLinearForm(mfem._par.linearform.LinearForm):
    ...
    def SupportsDevice(self):
        r"""SupportsDevice(ParLinearForm self) -> bool"""
        return _plinearform.ParLinearForm_SupportsDevice(self)
    SupportsDevice = _swig_new_instance_method(_plinearform.ParLinearForm_SupportsDevice)
