...
class ParFiniteElementSpace(mfem._par.fespace.FiniteElementSpace):
    ...
    def GetFaceRestriction(self, *args, **kwargs):
        r"""GetFaceRestriction(ParFiniteElementSpace self, mfem::ElementDofOrdering f_ordering, mfem::FaceType type, mfem::L2FaceValues mul=DoubleValued) -> FaceRestriction"""
