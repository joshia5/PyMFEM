...
class ParNCH1FaceRestriction(mfem._par.restriction.ConformingFaceRestriction):
    ...
    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(ParNCH1FaceRestriction self, Vector x, Vector y, double const a=1.0)"""
        return _prestriction.ParNCH1FaceRestriction_AddMultTranspose(self, x, y, a)
    ...
    def AddMultTransposeInPlace(self, x, y):
        r"""AddMultTransposeInPlace(ParNCH1FaceRestriction self, Vector x, Vector y)"""
        return _prestriction.ParNCH1FaceRestriction_AddMultTransposeInPlace(self, x, y)
    AddMultTransposeInPlace = _swig_new_instance_method(_prestriction.ParNCH1FaceRestriction_AddMultTransposeInPlace)

    def NonconformingInterpolation(self, x):
        r"""NonconformingInterpolation(ParNCH1FaceRestriction self, Vector x)"""
        return _prestriction.ParNCH1FaceRestriction_NonconformingInterpolation(self, x)
    NonconformingInterpolation = _swig_new_instance_method(_prestriction.ParNCH1FaceRestriction_NonconformingInterpolation)

    def NonconformingTransposeInterpolation(self, x):
        r"""NonconformingTransposeInterpolation(ParNCH1FaceRestriction self, Vector x)"""
        return _prestriction.ParNCH1FaceRestriction_NonconformingTransposeInterpolation(self, x)
    NonconformingTransposeInterpolation = _swig_new_instance_method(_prestriction.ParNCH1FaceRestriction_NonconformingTransposeInterpolation)

    def NonconformingTransposeInterpolationInPlace(self, x):
        r"""NonconformingTransposeInterpolationInPlace(ParNCH1FaceRestriction self, Vector x)"""
        return _prestriction.ParNCH1FaceRestriction_NonconformingTransposeInterpolationInPlace(self, x)
    NonconformingTransposeInterpolationInPlace = _swig_new_instance_method(_prestriction.ParNCH1FaceRestriction_NonconformingTransposeInterpolationInPlace)
...
class ParNCL2FaceRestriction(mfem._par.restriction.NCL2FaceRestriction, ParL2FaceRestriction):
    ...
    def AddMultTranspose(self, x, y, a=1.0):
        r"""AddMultTranspose(ParNCL2FaceRestriction self, Vector x, Vector y, double const a=1.0)"""
        return _prestriction.ParNCL2FaceRestriction_AddMultTranspose(self, x, y, a)
    AddMultTranspose = _swig_new_instance_method(_prestriction.ParNCL2FaceRestriction_AddMultTranspose)

    def AddMultTransposeInPlace(self, x, y):
        r"""AddMultTransposeInPlace(ParNCL2FaceRestriction self, Vector x, Vector y)"""
        return _prestriction.ParNCL2FaceRestriction_AddMultTransposeInPlace(self, x, y)
    AddMultTransposeInPlace = _swig_new_instance_method(_prestriction.ParNCL2FaceRestriction_AddMultTransposeInPlace)
